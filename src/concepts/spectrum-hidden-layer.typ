...
// ============================================================================
// Plot helpers for section composition
// ============================================================================
...
#grid(
  ...
  [
    ...
    #block(
      ...
      #v(4pt)
      #copy-block(size: 8.5pt)[
        Do not ask only whether the light is warm or cool. Ask where the energy is, where it is missing, and how the spectrum is made.
      ]
    ]
  ],
